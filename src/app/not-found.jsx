...
const NotFound = () => {
    return (
        <div className='fixed inset-0 bg-gray-100 flex text-center flex-col items-center justify-center z-50 space-y-4'>
                ...
                <p className='mb-6 text-lg text-gray-600'>The page does not exist. Looks like this friendship link is broken. The page <br /> you&apos;re looking for doesn&apos;t exist or has been moved.</p>
            <Link href="/">
